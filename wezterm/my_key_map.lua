...
function module.get_my_key_map() -- don't forget to add it to the module table!!
	return { -- TODO: return a table with 'keys' table, or just the 'keys' table?
		keys = {
			...
			-- i haven't really used more than one tab.. i usually just create a split and then delete it.. or use the focus/hide other panes feature
			...
			-- changed bindings:
			{ key = "phys:Space", mods = mod_with_shift_key, action = act.ActivateCommandPalette },
			...
			-- additional mappings
			{ key = "p", mods = mod_with_shift_key, action = act.ActivateCommandPalette },
